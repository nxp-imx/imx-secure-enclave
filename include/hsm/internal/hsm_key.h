...
typedef enum {
	...
	PERMITTED_ALGO_CTR				= ALGO_CTR,
	PERMITTED_ALGO_ECB_NO_PADDING	= ALGO_ECB_NO_PADDING,
	PERMITTED_ALGO_CBC_NO_PADDING	= ALGO_CBC_NO_PADDING,
	...
	PERMITTED_ALGO_ALL_CIPHER		= ALGO_ALL_CIPHER,
